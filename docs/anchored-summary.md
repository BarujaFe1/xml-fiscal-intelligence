...
## Next Steps
1. Pedir ao usuário: importar docs/pva/2026-06/output/EFD_03585024000490_20260601_20260630.txt no SpedEFD (ou gerar 202605 no site com hard-refresh) e enviar novo erros(N).csv se houver.
2. Se persistir erro, investigar próximo registro do CSV.
...
- src/modules/obligations/efd-icms-ipi/builders/index.ts — C170 38, C190 12, **0002 linha ~686 só p/ activityCode "0"**, build0000 ~237.
- src/modules/obligations/efd-icms-ipi/calculations/index.ts — **buildE110FromC190 agora 15 campos** (sem VL_SLD_CREDOR_ANT_FUT).
